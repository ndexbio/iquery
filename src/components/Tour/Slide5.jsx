...
import tourMovie5 from '../../assets/images/tourImages/tour_5_toolbar.gif'
...
const Slide5 = () => {
  ...
  return (
    <>
      <img src={tourMovie5} style={{border: '1.5px solid #0088D2', height: '60%', width: 'auto', marginLeft: 'auto', marginRight: 'auto', display: 'block', marginBottom: '5px'}}></img>      
